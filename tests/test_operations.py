...
from web.operations import digest
from web.mcp_transport import MCPError, MCPClient, validate_endpoint
...
class OperationsTests(unittest.TestCase):
    ...
    def test_sync_discovers_real_response_not_fixed_tools(self):
        ...
        with patch('web.operations.MCPClient',return_value=f):r=self.client.post('/api/mcp/connectors/'+cid+'/sync',json={})
    ...
    def test_success_and_duplicate_protection(self):
        ...
        with patch('web.operations.MCPClient',return_value=f):
    ...
    def test_changed_tool_is_not_executed(self):
        ...
        with patch('web.operations.MCPClient',return_value=f):r=self.client.post('/api/mcp/run',json=self.run_data(cid))
    ...
    def test_streamable_http_json_and_sse(self):
        ...
        with patch('web.mcp_transport.public_ip',return_value='8.8.8.8'),patch('web.mcp_transport.urllib3.HTTPSConnectionPool',return_value=pool):
