...
def install_security(app, db):
    ...
    def security_headers(response):
        ...
        response.headers['Content-Security-Policy']="default-src 'self'; script-src 'self' 'unsafe-inline' https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://embed.tawk.to https://va.tawk.to https://*.tawk.to; style-src 'self' 'unsafe-inline' https://embed.tawk.to https://*.tawk.to; img-src 'self' data: https://tile.openstreetmap.org https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://*.tawk.to https://embed.tawk.to https://va.tawk.to; font-src 'self' https://*.tawk.to; connect-src 'self' https://pagead2.googlesyndication.com https://*.tawk.to https://embed.tawk.to https://va.tawk.to wss://*.tawk.to; frame-src 'self' https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://*.tawk.to https://embed.tawk.to https://va.tawk.to; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'self'" if production else "default-src 'self'; script-src 'self' 'unsafe-inline' https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://embed.tawk.to https://va.tawk.to https://*.tawk.to; style-src 'self' 'unsafe-inline' https://embed.tawk.to https://*.tawk.to; img-src 'self' data: https://tile.openstreetmap.org https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://*.tawk.to https://embed.tawk.to https://va.tawk.to; font-src 'self' https://*.tawk.to; connect-src 'self' https://pagead2.googlesyndication.com https://*.tawk.to https://embed.tawk.to https://va.tawk.to wss://*.tawk.to; frame-src 'self' https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://*.tawk.to https://embed.tawk.to https://va.tawk.to; object-src 'none'; base-uri 'self'; form-action 'self'"
