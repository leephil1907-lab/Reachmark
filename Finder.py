...
Usage:
  python Finder.py --location "Lagos, Nigeria" --category "Café" --check
  python Finder.py --global "Lagos, Nigeria|Accra, Ghana" --category "Clinic" --check
"""

import sys, json
from services import geocode, discover_location, audit_website, classify
