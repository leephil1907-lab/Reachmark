...
refresh().then(()=>{const page=location.hash.slice(1);if(['overview','leads','outreach','settings','global','health','portfolio','enquiries','integrations','contracts','projects'].includes(page))navigate(page)}).catch(e=>toast(e.message,true));
